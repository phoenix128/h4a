...
const generatePluginList = (
    ...
    for (const [moduleName, modulePath] of Object.entries(modules)) {
        ...
        ifBlocksCode.push(
            `if (moduleName === "${moduleName}") return ${importName};`
        );
    }
    ...
    const ${functionName} = (moduleName: string): ${returnType} | null => {
...
module.exports = generatePluginList;
